    ...
    <main className="bg-black leading-6 text-white">
      <div className="mx-auto max-w-5xl">
        <div className="px-5 py-8">
          ...
          <div className="mb-4 flex flex-col gap-4 rounded-3xl bg-gradient-to-br from-blue-500 to-purple-950 p-6 lg:flex-row-reverse lg:bg-gradient-to-r lg:py-8 lg:pr-0">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="mb-2">
                Wir sind Jonathan & Vera und zusammen sind wir Better Together
                💜 Wir leben in Berlin und sind für euch in der Region
          ...
          <div className="">
            <div className="mb-4 flex flex-col gap-4 rounded-3xl bg-gradient-to-tr from-blue-500 to-purple-950 p-6 lg:ml-56 lg:flex-row-reverse lg:bg-gradient-to-l lg:py-8 lg:pr-0">
              {/* <!-- Bild: Jonathan --> */}
              <div className="relative lg:w-1/2">
                <img
            ...
            <div className="mb-4 flex flex-col gap-4 rounded-3xl bg-gradient-to-bl from-blue-500 to-purple-950 p-6 lg:mr-56 lg:flex-row lg:bg-gradient-to-r lg:py-8 lg:pl-0">
              <div className="relative lg:w-1/2">
                {/* <!-- Bild: Vera--> */}
                <img
